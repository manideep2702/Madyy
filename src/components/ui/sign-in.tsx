...
export const SignInPage: React.FC<SignInPageProps> = ({
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col md:flex-row font-geist w-[100dvw] bg-background pb-24 sm:pb-20 [padding-bottom:env(safe-area-inset-bottom)]">
                ...
                <GlassInputWrapper>
                  <div className="relative">
                    ...
                    <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute inset-y-0 right-3 flex items-center">
                      {showPassword ? <Eye className="w-5 h-5 text-muted-foreground hover:text-foreground transition-colors" /> : <EyeOff className="w-5 h-5 text-muted-foreground hover:text-foreground transition-colors" />}
                    </button>
                  </div>
                </GlassInputWrapper>
              </div>
