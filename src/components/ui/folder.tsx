  ...
  return (
    <div style={folderBaseStyle} className={className}>
      ...
      >
        ...
        >
          <span
            className="absolute z-0 bottom-[99%] left-0 w-[30px] h-[10px] rounded-tl-[5px] rounded-tr-[5px]"
            style={{ backgroundColor: folderBackColor }}
          ></span>
          {papers.map((_itemContent, i) => {
            ...
            return (
              <div
                ...
                className={`absolute bottom-[10%] left-1/2 transition-all duration-300 ease-in-out transform ${paperHoverTransform} ${sizeClasses}`}
                style={{
                  zIndex: 10 + i,
                  backgroundColor:
                    i === 0 ? paper1Color : i === 1 ? paper2Color : paper3Color,
                  borderRadius: "6px",
